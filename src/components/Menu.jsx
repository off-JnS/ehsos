...
const CROQUE = [
  { name: 'Pute', allergens: '1, 3, a, g', desc: 'Putenbrust, Tomaten und Edamer', img: '/menu-images/croque/Pute_Croque_Ultra-premium_professional_food_202605032211.jpeg' },
  { name: 'Salami', allergens: '1, 2, 3, a, g', desc: 'Rindersalami, Gewürzgurken und Edamer', img: '/menu-images/croque/Salami_Croque_Ultra-premium_professional_food_202605032245.jpeg' },
  { name: 'Pute Ananas', allergens: '1, 3, a, g', desc: 'Putenbrust, Ananas und Edamer', img: '/menu-images/croque/Pute_Ananas_Croque_Ultra-premium_professional_202605032250.jpeg' },
  { name: 'Pute Bacon', allergens: '1, 3, a, g', desc: 'Putenbrust, Tomaten, Rinder-Bacon und Edamer', img: '/menu-images/croque/Pute_Bacon_Croque_Ultra-premium_professional_202605032301.jpeg' },
  { name: 'Spicy Chicken', allergens: 'a, g', desc: 'Spicy Chicken, Tomaten, rote Zwiebeln und Edamer', img: '/menu-images/croque/Crispy_Chicken_croque_Ultra-premium_professional_202605040117.jpeg' },
  { name: 'Crispy Chicken', allergens: 'a, g', desc: 'Crispy Chicken, Tomaten, Jalapeños und Cheddar', img: '/menu-images/croque/Crispy_Chicken_croque_Ultra-premium_professional_202605040117.jpeg' },
  { name: 'Sucuk', allergens: '1, 2, 3, a, g', desc: 'Knoblauchwurst, Tomaten und Edamer', img: '/menu-images/croque/sucuk_Egg_croque_Ultra-premium_professional_202605040117.jpeg' },
  { name: 'Sucuk Egg', allergens: '1, 2, 3, a, g', desc: 'Knoblauchwurst, gekochtes Ei, Tomaten und Edamer', img: '/menu-images/croque/sucuk_Egg_croque_Ultra-premium_professional_202605040117.jpeg' },
  { name: 'Chicken Bacon', allergens: '1, 3, a, g', desc: 'Hähnchenbrust, Rinder-Bacon, Tomaten, karamellisierte Zwiebeln und Edamer', img: '/menu-images/croque/Schinken_Bacon_croque_Ultra-premium_professional_202605040117.jpeg' },
  { name: 'Chicken Bacon Egg', allergens: '1, 3, a, g', desc: 'Hähnchenbrust, gekochtes Ei, Rinder-Bacon, Tomaten, karamellisierte Zwiebeln und Edamer', img: '/menu-images/croque/Schinken_Bacon_croque_Ultra-premium_professional_202605040117.jpeg' },
  { name: 'Burger', allergens: 'a, g', desc: 'Burgerfleisch, Tomaten, karamellisierte Zwiebeln und Cheddar', img: '/menu-images/croque/Burger_croque_Ultra-premium_professional_food_202605040043.jpeg' },
  { name: 'Thunfisch', allergens: 'a, c, g', desc: 'Thunfisch, Tomaten und Edamer', img: '/menu-images/croque/Thunfisch_croque_Ultra-premium_professional_food_202605040043.jpeg' },
  { name: 'Hot Dog', allergens: '1, 3, a, g, l', desc: 'Hot Dog Wurst, dänische Gurken, Röstzwiebeln, Ketchup und Edamer', img: '/menu-images/croque/Hot_Dog_croque_Ultra-premium_professional_202605040115.jpeg' },
  { name: 'Frikadelle', allergens: 'a, g, l', desc: 'Frikadelle, Tomaten, Ketchup und Edamer', img: '/menu-images/croque/Frikadellen_croque_Ultra-premium_professional_food_202605040116.jpeg' },
  { name: 'Schinken', allergens: 'a, g, l', desc: 'Schinken, Tomaten und Edamer', img: '/menu-images/croque/Schinken_croque_Ultra-premium_professional_food_202605040052.jpeg' },
  { name: 'Hawaii', allergens: '1, 3, a, g', desc: 'Schinken, Ananas und Edamer', img: '/menu-images/croque/Hawaii_croque_Ultra-premium_professional_food_202605040052.jpeg' },
  { name: 'Taco Beef', allergens: 'a, g', desc: 'Rinderhack, Tomaten, Ketchup, rote Zwiebeln und Edamer', img: '/menu-images/croque/Taco_beef_croque_Ultra-premium_professional_202605040043.jpeg' },
  { name: 'Schafskäse', allergens: 'a, g', desc: 'Schafskäse, Gurken und Tomaten', img: '/menu-images/croque/Schafskäse_croque_Ultra-premium_professional_food_202605040052.jpeg' },
  { name: 'Mozzarella', allergens: 'a, g', desc: 'Tomaten und Mozzarella', img: '/menu-images/croque/Mozzarella_croque_Ultra-premium_professional_food_202605040116.jpeg' },
]

const WRAP = [
  { name: 'Crispy Chicken', price: '8,50 €', allergens: 'a, g', desc: 'Crispy Chicken, Jalapeños und Chesterkäse', img: '/menu-images/wrap/Crispy Chicken Wrap.png' },
  { name: 'Chicken Bacon', price: '8,50 €', allergens: '1, 3, a, g', desc: 'Hähnchenbrustfilet, Rinder-Bacon, Tomaten, karamellisierte Zwiebeln', img: '/menu-images/wrap/Chicken Bacon wrap.jpeg' },
  { name: 'Taco Beef', price: '8,50 €', allergens: 'a, g', desc: 'Taco Beef, Jalapeños, Chesterkäse, karamellisierte Zwiebeln, Tomaten', img: '/menu-images/wrap/Taco Beef wrap.jpeg' },
  { name: 'Thunfisch Kapern', price: '8,50 €', allergens: 'a, c, g', desc: 'Thunfisch, Kapern und rote Zwiebeln', img: '/menu-images/wrap/Thunfisch Kapern Wrap.jpeg' },
  ...
  { name: 'Spicy Chicken', price: '8,50 €', allergens: 'a, g', desc: 'Hähnchenbrustfilet, Jalapeños, Tomaten, karamellisierte Zwiebeln', img: '/menu-images/wrap/Spicy Chicken.png' },
  { name: 'Burger', price: '8,50 €', allergens: 'a, g', desc: 'Burgerfleisch, Tomaten, karamellisierte Zwiebeln und Edamer', img: '/menu-images/wrap/Burger Wrap.jpeg' },
  { name: 'Schafskäse', price: '8,50 €', allergens: '9, 13, a, g', desc: 'Schafskäse, Oliven, Tomaten, karamellisierte Zwiebeln', img: '/menu-images/wrap/Schafskäse Wrap.jpeg' },
]
