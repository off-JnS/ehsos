...
const CROQUE = [
  { name: 'Pute', allergens: '1, 3, a, g', desc: 'Putenbrust, Tomaten und Edamer', img: '/menu-images/croque/Pute Croque.jpeg' },
  { name: 'Salami', allergens: '1, 2, 3, a, g', desc: 'Rindersalami, Gewürzgurken und Edamer', img: '/menu-images/croque/Salami Croque.jpeg' },
  { name: 'Pute Ananas', allergens: '1, 3, a, g', desc: 'Putenbrust, Ananas und Edamer', img: '/menu-images/croque/Pute Ananas Croque.jpeg' },
  { name: 'Pute Bacon', allergens: '1, 3, a, g', desc: 'Putenbrust, Tomaten, Rinder-Bacon und Edamer', img: '/menu-images/croque/Pute Bacon Croque.jpeg' },
  { name: 'Spicy Chicken', allergens: 'a, g', desc: 'Spicy Chicken, Tomaten, rote Zwiebeln und Edamer', img: '/menu-images/croque/Crispy Chicken croque.jpeg' },
  { name: 'Crispy Chicken', allergens: 'a, g', desc: 'Crispy Chicken, Tomaten, Jalapeños und Cheddar', img: '/menu-images/croque/Crispy Chicken croque.jpeg' },
  { name: 'Sucuk', allergens: '1, 2, 3, a, g', desc: 'Knoblauchwurst, Tomaten und Edamer', img: '/menu-images/croque/sucuk Egg croque.jpeg' },
  { name: 'Sucuk Egg', allergens: '1, 2, 3, a, g', desc: 'Knoblauchwurst, gekochtes Ei, Tomaten und Edamer', img: '/menu-images/croque/sucuk Egg croque.jpeg' },
  { name: 'Chicken Bacon', allergens: '1, 3, a, g', desc: 'Hähnchenbrust, Rinder-Bacon, Tomaten, karamellisierte Zwiebeln und Edamer', img: '/menu-images/croque/Schinken Bacon croque.jpeg' },
  { name: 'Chicken Bacon Egg', allergens: '1, 3, a, g', desc: 'Hähnchenbrust, gekochtes Ei, Rinder-Bacon, Tomaten, karamellisierte Zwiebeln und Edamer', img: '/menu-images/croque/Schinken Bacon croque.jpeg' },
  { name: 'Burger', allergens: 'a, g', desc: 'Burgerfleisch, Tomaten, karamellisierte Zwiebeln und Cheddar', img: '/menu-images/croque/Burger croque.jpeg' },
  { name: 'Thunfisch', allergens: 'a, c, g', desc: 'Thunfisch, Tomaten und Edamer', img: '/menu-images/croque/Thunfisch croque.jpeg' },
  { name: 'Hot Dog', allergens: '1, 3, a, g, l', desc: 'Hot Dog Wurst, dänische Gurken, Röstzwiebeln, Ketchup und Edamer', img: '/menu-images/croque/Hot Dog croque.jpeg' },
  { name: 'Frikadelle', allergens: 'a, g, l', desc: 'Frikadelle, Tomaten, Ketchup und Edamer', img: '/menu-images/croque/Frikadellen croque.jpeg' },
  { name: 'Schinken', allergens: 'a, g, l', desc: 'Schinken, Tomaten und Edamer', img: '/menu-images/croque/Schinken croque.jpeg' },
  { name: 'Hawaii', allergens: '1, 3, a, g', desc: 'Schinken, Ananas und Edamer', img: '/menu-images/croque/Hawaii croque.jpeg' },
  { name: 'Taco Beef', allergens: 'a, g', desc: 'Rinderhack, Tomaten, Ketchup, rote Zwiebeln und Edamer', img: '/menu-images/croque/Taco beef croque.jpeg' },
  { name: 'Schafskäse', allergens: 'a, g', desc: 'Schafskäse, Gurken und Tomaten', img: '/menu-images/croque/Schafskase croque.jpeg' },
  { name: 'Mozzarella', allergens: 'a, g', desc: 'Tomaten und Mozzarella', img: '/menu-images/croque/Mozzarella croque.jpeg' },
]
...
const WRAP = [
  ...
  { name: 'Bacon Ei', price: '8,50 €', allergens: '1, 3, a, d, g', desc: 'Rinder-Bacon, Ei, Tomaten und karamellisierte Zwiebeln', img: '/menu-images/wrap/Bacon Ei Wrap.jpeg' },
  { name: 'Chicken Egg', price: '8,50 €', allergens: 'a, g', desc: 'Hähnchenbrustfilet, Ei, Tomaten', img: '/menu-images/wrap/Chicken Egg Wrap.jpeg' },
  ...
  { name: 'Schafskäse', price: '8,50 €', allergens: '9, 13, a, g', desc: 'Schafskäse, Oliven, Tomaten, karamellisierte Zwiebeln', img: '/menu-images/wrap/Schafskase Wrap.jpeg' },
]
